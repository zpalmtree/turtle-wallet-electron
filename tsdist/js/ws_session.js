...
var WalletShellSession = function (opts) {
    if (!(this instanceof WalletShellSession))
        return new WalletShellSession(opts);
    opts = opts || {};
    ...
    /* jshint ignore:start */
    this.keys = Object.keys(Object.assign({}, this.sessDefault, this.stickyVals));
    // initialize
    if (!sessionStorage.getItem(this.sessKey)) {
        sessionStorage.setItem(this.sessKey, JSON.stringify(Object.assign({}, this.sessDefault, this.stickyVals)));
    }
    /* jshint ignore:end */
};
...
WalletShellSession.prototype.reset = function (key) {
    ...
    /* jshint ignore: start */
    return sessionStorage.setItem(this.sessKey, JSON.stringify(Object.assign({}, this.sessDefault, stickyData)));
    /* jshint ignore: end */
};
